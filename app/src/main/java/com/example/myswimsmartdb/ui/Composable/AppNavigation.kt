...
@Composable
fun AppNavigation(navController: NavHostController, sharedViewModel: SharedViewModel, baderegelRepository: BaderegelRepository) {
    NavHost(navController = navController, startDestination = "home") {
        ...
        composable("quiz") { QuizScreen(navController, sharedViewModel, baderegelRepository) }
    }
}
